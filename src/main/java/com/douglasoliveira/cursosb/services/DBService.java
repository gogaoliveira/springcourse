...
import com.douglasoliveira.cursosb.domain.Pagamento;
import com.douglasoliveira.cursosb.domain.PagamentoComBoleto;
import com.douglasoliveira.cursosb.domain.PagamentoComCartao;
...
import com.douglasoliveira.cursosb.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "2doug077@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Eric Silva", "doug077@hotmail.com", "35556161453", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("11111111", "99999999"));

		Endereco e1 = new Endereco(null, "rua flores", "300", "apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "1105", null, "Centro", "88906740", cli2, c2);
